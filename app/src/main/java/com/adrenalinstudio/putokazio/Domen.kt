...
class Domen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_domen)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("domen", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("domen", !savedBoolean2)
            }.apply()
            val intent = Intent(this,Internet2::class.java)
            intent.putExtra("domenbt",true)
