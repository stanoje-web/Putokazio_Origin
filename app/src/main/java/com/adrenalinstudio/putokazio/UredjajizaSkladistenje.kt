...
class UredjajizaSkladistenje : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_uredjajiza_skladistenje)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("uređajizaskladištenja", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("uređajizaskladištenja", !savedBoolean2)
            }.apply()
            val intent = Intent(this,LinuxovKernel::class.java)
            intent.putExtra("uređajizaskladištenjabt",true)
