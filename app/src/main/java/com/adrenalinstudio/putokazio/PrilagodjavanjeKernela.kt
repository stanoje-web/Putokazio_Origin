...
class PrilagodjavanjeKernela : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_prilagodjavanje_kernela)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("prilagođavanjekernela", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("prilagođavanjekernela", !savedBoolean2)
            }.apply()
            val intent = Intent(this,LinuxovKernel::class.java)
            intent.putExtra("prilagođavanjekernelabt",true)
