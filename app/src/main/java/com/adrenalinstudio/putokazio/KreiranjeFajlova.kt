...
class KreiranjeFajlova : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kreiranje_fajlova)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("kreiranjefajlova", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("kreiranjefajlova", !savedBoolean2)
            }.apply()
            val intent = Intent(this,InterfejsKomandneLinije::class.java)
            intent.putExtra("kreiranjefajlovabt",true)
