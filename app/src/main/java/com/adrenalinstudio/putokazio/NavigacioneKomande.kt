...
class NavigacioneKomande : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_navigacione_komande)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("navigacionekomande", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("navigacionekomande", !savedBoolean2)
            }.apply()
            val intent = Intent(this,InterfejsKomandneLinije::class.java)
            intent.putExtra("navigacionekomandebt",true)
