...
class OKontroliVerzije : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_o_kontroli_verzije)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("kontrola", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("kontrola", !savedBoolean2)
            }.apply()
            val intent = Intent(this,Git::class.java)
            intent.putExtra("kontrolabt",true)
