...
class GIMP : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_g_i_m_p)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("gimp", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("gimp", !savedBoolean2)
            }.apply()
            val intent = Intent(this,GrafickiProgrami::class.java)
            intent.putExtra("gimpbt",true)
