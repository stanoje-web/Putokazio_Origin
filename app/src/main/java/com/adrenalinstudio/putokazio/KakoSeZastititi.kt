...
class KakoSeZastititi : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kako_se_zastititi)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("kakosezastititi", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("kakosezastititi", !savedBoolean2)
            }.apply()
            val intent = Intent(this,Covid19::class.java)
            intent.putExtra("kakosezastititibt",true)
