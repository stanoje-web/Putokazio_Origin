...
class ViEditor : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_vi_editor)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("vieditor", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("vieditor", !savedBoolean2)
            }.apply()
            val intent = Intent(this,InterfejsKomandneLinije::class.java)
            intent.putExtra("vieditorbt",true)
