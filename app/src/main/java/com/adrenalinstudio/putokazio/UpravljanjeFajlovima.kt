...
class UpravljanjeFajlovima : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_upravljanje_fajlovima)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("upravljanjefajlovima", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("upravljanjefajlovima", !savedBoolean2)
            }.apply()
            val intent = Intent(this,InterfejsKomandneLinije::class.java)
            intent.putExtra("upravljanjefajlovimabt",true)
