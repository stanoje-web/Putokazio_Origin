...
class PravljenjeRepozitorijuma : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pravljenje_repozitorijuma)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("repozitorijum", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("repozitorijum", !savedBoolean2)
            }.apply()
            val intent = Intent(this,Git::class.java)
            intent.putExtra("repozitorijumbt",true)
