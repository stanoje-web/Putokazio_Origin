...
class KomandnaLinija : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_komandna_linija)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("komandnalinija", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("komandnalinija", !savedBoolean2)
            }.apply()
            val intent = Intent(this,Git::class.java)
            intent.putExtra("komandnalinijabt",true)
