...
class PrikazivaciSlika : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_prikazivaci_slika)
        ...
        val savedBoolean2=sharedPreferences2.getBoolean("prikazivacislika", false)
        ...
        boolean2.setOnCheckedChangeListener { _, isChecked ->
            ...
            edit.apply{
                putBoolean("prikazivacislika", !savedBoolean2)
            }.apply()
            val intent = Intent(this,GrafickiProgrami::class.java)
            intent.putExtra("prikazivacislikabt",true)
